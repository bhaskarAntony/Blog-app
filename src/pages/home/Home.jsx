...
function Home() {
  ...
  <section className="home">
        ...
        <br />
        <p className='text-red'><big>By Rob Enderle - November 18, 2024 5:00 AM PT - <a href="mailto:bhaskarAntony@gmail.com" className='text-red'>Email Article</a></big></p>
        <br />
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJweD2Ekz2XXf8dTFtW5eiRHq7EGPGHOLlrQ&s" alt=""  className='main-image'/>
        <p><b>Chairman and CEO Satya Nadella speaks at Microsoft Ignite 2023. (Photo by Dan DeLong)</b></p>
        <br />
        <hr />
        <p><big><a href="https://www.technewsworld.com/lead-generation-services" className='text-red' target="_blank"><b>Engage with IT decision makers and key influencers.</b></a></big></p>
        <p className='content'>TechNewsWorld's B2B marketing services deliver sales-ready leads that shorten your sales process. Fill your funnel and grow revenue with our lead gen expertise.  <span className="text-red"> Get Started Today</span></p>
        <br />
        <p className="content big">
        <span className="text-red">Microsoft Ignite</span> is on this week. It’s the company’s massive event focused on IT professionals. While you can attend this event remotely, you should consider attending in person this year because I still see far more AI failures than successes. When AI is deployed successfully, it has a significant positive impact on productivity, yet quality appears to be going in the wrong direction. But not for everyone.
        </p> <br />
        ...
        <br />
        <h2>Genuine Value vs. Exaggerated Claims</h2>
        <br />
        <p className="content">
